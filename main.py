...
text = """
   ...
   ____                            _______ _                       
  / __ \                          |__   __| |                      
 | |  | |_   _  __ _ _ __   __ _     | |  | |__   __ _ _ __   __ _ 
 | |  | | | | |/ _` | '_ \ / _` |    | |  | '_ \ / _` | '_ \ / _` |
 | |__| | |_| | (_| | | | | (_| |    | |  | | | | (_| | | | | (_| |
  \___\_\\__,_|\__,_|_| |_|\__, |    |_|  |_| |_|\__,_|_| |_|\__, |
                            __/ |                             __/ |
                           |___/                             |___/ 
"""
            ...
            if thread_type == ThreadType.USER:
                ...
                if author_id in temp_thread_storage:
                    ...
                    if now - last_message_time < 7200:
                        return
                msg = f"Chào {author_name} đây là bot zalo của admin QuangThang\n\n> Nếu bạn có nhu cầu code bot mua bot hay mua acc game thì hãy liên hệ qua\n\n• Facebook: https://www.facebook.com/profile.php?id=1444789137\n• Zalo: 0359442274\n\n> Cảm ơn đã liên hệ."
