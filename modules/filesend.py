...
des = {
    'version': "1.0.0",
    'credits': "QuangThang",
    'description': "Gửi link code đến người được tag"
}
...
def handle_filesend_command(message, message_object, thread_id, thread_type, author_id, client):
    ...
    if command_content is None:
        ...
        if error:
            ...
            gui = f"Gửi code {command_name} thành công đến người dùng: {author_name}"
...
def get_mitaizl():
    return {
        'filesend': handle_filesend_command
    }
